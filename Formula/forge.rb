...
class Forge < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/e2p-ai/forge/releases/download/v#{version}/forge-v#{version}-aarch64-apple-darwin.tar.gz"
      sha256 "917f8b5a40d30cd4bc78102470bd153d98c3dcacdc618b7c9c3f88df9f04157e"
    else
      url "https://github.com/e2p-ai/forge/releases/download/v#{version}/forge-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "1ad6f8cb43220283510b18be315b0f501059727a9b06b1678847557742114912"
    end
  end

  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/e2p-ai/forge/releases/download/v#{version}/forge-v#{version}-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "d688198e3f8a7d2ff5f019020df0e53a8d127e17a1246ebe485bc843093ac237"
    else
      url "https://github.com/e2p-ai/forge/releases/download/v#{version}/forge-v#{version}-x86_64-unknown-linux-gnu.tar.gz"
      sha256 "ffd4e838a54b200292ba1187acf7e7a7b525a518d00a7615b9b5ce2d2807c944"
    end
  end
